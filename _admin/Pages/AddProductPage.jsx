	...
	render() {
		...
		return(
			<div>
				...
				<ProductForm informationMessageHandler = { this.state.informationMessageHandler } resetInputElements = { this.state.resetInputElements } />
			</div>
		);
	}
}