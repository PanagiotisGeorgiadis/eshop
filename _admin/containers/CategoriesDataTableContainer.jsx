...
class CategoriesDataTableContainer extends React.Component {
	...
	removeEntry(entryId) {
		...
		this.state.deleteCategory(entryId);
	}
	...
	componentWillReceiveProps(nextProps) {
		...
		if(nextProps.categories && nextProps.categories.length)
			this.updateTableRows(updatedState, nextProps.categories);
	...
	componentWillMount() {
		...
		this.props.updatePageTitle("Εμφάνιση Κατηγοριών");

		if(!this.props.categories)
			this.props.getCategories(url);
	}
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoriesDataTableContainer);
